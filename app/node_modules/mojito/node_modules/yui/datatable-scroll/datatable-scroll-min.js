...
}}},_unbindScrollbar:function(){if(this._scrollbarEventHandle){this._scrollbarEventHandle.detach();}},_unbindScrollResize:function(){if(this._scrollResizeHandle){this._scrollResizeHandle.detach();delete this._scrollResizeHandle;}}},true);g.Base.mix(g.DataTable,[b]);},"3.5.1-2",{skinnable:true,requires:["datatable-base","dom-screen"]});
